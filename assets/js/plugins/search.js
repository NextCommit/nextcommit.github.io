...
function processData() {
    ...
    return function(data) {
        ...
        $.each(data, function(index, item) {
            ...
            if (item.excerpt.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.title.toLowerCase().indexOf(q.toLowerCase()) > -1 || item.content.toLowerCase().indexOf(q.toLowerCase()) > -1) {
